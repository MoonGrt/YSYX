...
class IFU extends Module {
  ...
  //   sIdle -> Mux(io.ibus.addr.fire, sWait, sIdle),
  ...
  val npc = Mux(io.ibus.addr.fire , Mux(bren, braddr, pc + 4.U), pc)
  pc := npc
  // -------- Inst Bus --------
  io.ibus.addr.bits := pc
  io.ibus.addr.valid := io.ibus.addr.ready
  io.ibus.data.ready := true.B
  // -----------------------------------------------
  // -------------------- Output -------------------
  // -----------------------------------------------
