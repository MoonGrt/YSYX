...
void VMiniRVSOC___024root___configure_coverage(VMiniRVSOC___024root* vlSelf, bool first);

void VMiniRVSOC___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    VMiniRVSOC___024root___configure_coverage(this, first);
}
...
// Coverage
void VMiniRVSOC___024root::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void VMiniRVSOC___024root::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
